...
func Test_CI_DefaultCIConfig(t *testing.T) {
	// this lets the test harness to unset any DRIVE_CONFIG env var
	t.Setenv("DRIVE_CONFIG", "-")
...
func Test_CI_Fail(t *testing.T) {
	t.Setenv("DRIVE_CONFIG", "./testdata/image-multi-layer-dockerfile/drive-fail.yaml")
...
func Test_CI_LegacyRules(t *testing.T) {
	t.Setenv("DRIVE_CONFIG", "./testdata/config/drive-ci-legacy.yaml")
